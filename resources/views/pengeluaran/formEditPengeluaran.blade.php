                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-2 px-4 text-right">
                                        <a href={{ route('addBarang',['id'=>$product->id, 'sessionName' => 'editDaftarPengeluaran']) }}>
                                            <button type="button"
        ...
        <script>
            $(".remove-barang").click(function(e) {
                ...
                if (confirm("Yakin ingin menghapus item?")) {
                    $.ajax({
                    url: "{{ route('removeBarang', 'editDaftarPengeluaran') }}",
                        method: "DELETE",
                        data: {
                            _token: '{{ csrf_token() }}',
            ...
            $(".update-barang").change(function(e) {
                ...
                var ele = $(this);
                $.ajax({
                    url: "{{ route('editBarang','editDaftarPengeluaran') }}",
                    method: "patch",
                    data: {
                        _token: '{{ csrf_token() }}',
                        id: ele.parents("tr").attr("data-id"),
