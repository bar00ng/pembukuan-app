            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <form action={{ route('income.delete', ['id' => $d->id]) }} method="post"
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-5">
                <a href={{ route('income.form.tambah') }}>
                    <button type="button"
                ...
                <a href={{ route('outcome.form.tambah') }}>
                    <button type="button"
                                    ...
                                    @foreach ($data as $day => $data_list)
                                        ...
                                        @foreach ($data_list as $d)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td class="py-4 px-6">
                                                    @if ($d->isPemasukan == 1)
                                                    <a href={{ route('income.form.edit', ['id' => $d->id]) }}
                                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>    
                                                    @else
                                                    <a href={{ route('outcome.form.edit', ['id' => $d->id]) }}
                                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                    @endif
