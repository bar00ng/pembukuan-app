...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href={{ route('category.form.tambah') }}>
                <button type="button"
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="text-center flex items-center">
                                            <a href={{ route('category.form.edit',['id'=> $category['id']]) }}
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                            
                                                <form action={{route('category.delete',['id'=>$category['id']])}} method="post" class="ml-4">
                                                    @method('delete')
                                                    @csrf
                                                    <button
